...
# RMSE
accuracy1 <- sqrt(mean(movies_test$Collection - test_pred)^2)
accuracy1
...
# RMSE
accuracy_train <- sqrt(mean(movies_train$Collection - train_pred)^2)
accuracy_train
...
# RMSE on Train Data
train_accuracy_fultree <- sqrt(mean(movies_train$Collection - train_pred_fultree)^2)
...
# RMSE on Train Data
train_accuracy_fultree2 <- sqrt(mean(movies_train$Collection - train_pred_prune1)^2)
...
# RMSE on Train Data
train_accuracy_fultree2 <- sqrt(mean(movies_train$Collection - train_pred_prune2)^2)
train_accuracy_fultree2
