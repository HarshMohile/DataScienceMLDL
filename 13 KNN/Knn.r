...
# create normalization function (not scale cuz it gives vector which we dont want)
...
# create training and test data-------(X)
wbcd_train <- wbcd_n[1:469, ]
wbcd_test <- wbcd_n[470:569, ]

# create labels for training and test data---(Y)
