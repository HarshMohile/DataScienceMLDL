...
mwe_tokenizer.add_mwe(('Indian', 'Army'))
 # Adding more words to the set

mwe_tokenizer.tokenize(sentence5) #I', 'n','d','i','a',' ',
...
# TFIDF -Term frequency inverse  doc freq TF(t,d) * IDF(t) -- measure originality of term
