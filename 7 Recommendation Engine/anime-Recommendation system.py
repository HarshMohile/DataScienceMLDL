...
# import Dataset 
anime = pd.read_csv("D:\\360Assignments\\Submission\\7 Recommendation Engine\\anime.csv", encoding = 'utf8')
anime.shape # shape
anime.columns
...
# creating a mapping of anime name to index number  just for Example
...
def get_recommendations(Name, topN):    
    ...
    anime_id = anime_index[Name] #anime_index["Bad Boys (1995)"]
    ...
    cosine_scores_N = cosine_scores[0: 11] # topN+1
