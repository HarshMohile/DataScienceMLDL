...
def plot_daily_count_states(states=['Maharshtra'], day=TEST_DATE, mode=Mode.CASES, filename=None):
...
def plot_daily_count_countries(countries=['India'], day=TEST_DATE, mode=Mode.CASES, filename=None):
...
def plot_data(df, places, day, mode, column, filename):
	...
	for index, place in enumerate(places):
		...
		start_column = cumulative_data.columns.get_loc("3/18/20")
...
if __name__ == '__main__':
	...
	states = ["Maharashtra", "Delhi", "Kerela"]
