...
x<-readLines("C:/Datasets_BA/360DigiTMG/DS_India/360DigiTMG DS India Module wise PPTs/Module 18 Text Mining_Natural Language Processing (NLP)/Data/modi.txt")
...
bio <- readLines("C:/Datasets_BA/360DigiTMG/DS_India/360DigiTMG DS India Module wise PPTs/Module 18 Text Mining_Natural Language Processing (NLP)/Data/modi.txt")
...
# Load the dataset - movie script
my_example_text <- readLines("C:/Datasets_BA/TextMining/NLP/lotr.txt")
s_v <- get_sentences(my_example_text)

# Get sentiment measures using 3 different parsers
